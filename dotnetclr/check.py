...
DEFAULT_COUNTERS = [
    ...
    [".NET CLR Memory",     None, "# Total committed Bytes",     "dotnetclr.memory.committed_bytes",        "gauge"],
    [".NET CLR Memory",     None, "# Total reserved Bytes",     "dotnetclr.memory.reserved_bytes",        "gauge"],
    [".NET CLR Memory",     None, "# Bytes in all Heaps",     "dotnetclr.memory.heap_bytes",        "gauge"],
]
